<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="org.myweb.first.board.model.vo.Board" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <!-- JSTL core 라이브러리 선언 -->
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> <!-- JSTL fmt 라이브러리 선언 --> 
...
<table align="center" width="500" border="1" cellspacing="0" cellpadding="5">
   ...
   <tr>
      <th>내 용</th>
      <td><textarea rows="5" cols="50" name="boardContent">${ boardContent }</textarea></td>
   </tr>
   <tr>
      <th colspan="2">
