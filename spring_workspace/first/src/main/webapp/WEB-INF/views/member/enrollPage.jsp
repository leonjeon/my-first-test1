...
<table id="outer" align="center" width="700" cellspacing="5" cellpadding="0">
	...
	<tr><th width="120">*아이디</th>
		...
		<td rowspan="7" width="180" align="center" valign="middle">
			<div id="myphoto" 
			style="margin:0;width:190px;height:200px;padding:0;border:1px solid navy;">
				<img src="/first/resources/member_photofiles/come.jpg" id="photo" 				
				style="width:190px;height:200px;border:1px solid navy;display:block;"
				alt="사진을 드래그 드롭하세요." 
